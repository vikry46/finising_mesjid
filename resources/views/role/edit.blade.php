            ...
            @method('put')
             <div class="card-body">
                <div class="form-group">
                   ...
                   <input id="input_role_name" value="{{ old('name', $role->name) }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Masukkan Nama Role User..." readonly />
                   @error('name')
